...
import { getArtistInfoService } from '@/hooks/queries/artist/artistService';
    ...
    artistInfo && (
      <div className="w-full">
        <div className="flex w-full flex-col gap-8">
          <div className="prose prose-h4 flex justify-center">아티스트 수정</div>
          <ArtistAndTeamInfo type={type} data={artistInfo} />
        </div>
      </div>
    )
  );
