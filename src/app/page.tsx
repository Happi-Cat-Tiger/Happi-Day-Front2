      ...
      <div className="m-auto flex flex-col gap-16 md:max-w-[1280px]">
        ...
        <div className="flex h-[386px] flex-col justify-between">
          <div className="flex justify-between">
            <h2 className="prose-h4 border-b-[3px] border-orange2 p-2">인기 이벤트</h2>
            <button>More</button>
          </div>
          <div className="flex justify-between">
        ...
        <div className="flex h-[386px] flex-col justify-between">
          <div className="flex justify-between">
            <h2 className="prose-h4 border-b-[3px] border-orange2 p-2">인기 굿즈</h2>
            <button>More</button>
          </div>
          <div className="flex justify-between">
        ...
        <div className="flex h-[386px] flex-col justify-between">
          <div className="flex justify-between">
            <h2 className="prose-h4 border-b-[3px] border-orange2 p-2">인기 공구</h2>
            <button>More</button>
          </div>
          <div className="flex justify-between">
            <div className="h-[300px] w-[224px] border-2 border-black">카드</div>
